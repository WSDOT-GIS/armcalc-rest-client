...
let nock: (host: string, options?: Options) => Scope ;
...
let dateCompareEquality = function (first: any, second: any) {
...
function hasCorrectProperties(testObject: any) {
    ...
    let isDate = (o: any) => o instanceof Date;
    let isNumber = (o: any) => typeof o === "number";
    let isString = (o: any) => typeof o === "string";
    let isNullableString = (o: any) => o === null || isString(o);
        ...
        promise.then(acOuts => {
            ...
            acOuts.forEach((acOut, i) => {
                ...
                for (let propName of propNames) {
                    let inVal = (acIn as any)[propName];
                    let outVal = (acOut as any)[propName];
